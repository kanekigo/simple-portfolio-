    ...
    const features =[
        {
            ...
            title: "Clean Code",
            description: "Writing maintainable, scalable code following vest practices"
        },
        {
            icon: <Palette className="w-8 h-8 mb-4 text-black" />,
            title: "UI/UX Design",
            description: "Creating intuitibe interfaces with attention to detail"
        },
        {
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            <p className="text-lg text-gray-700 mb-6">
                                ...
                                I specialize in React, TypeScript, and modern CSS framework strong build scalable, performant applications.
                                </p>
                                <p className="text-lg text-gray-700 mb-6">
                                    My journey started with a curiosity for how websites  work, and it has evolved into a love for crafting
                                    pixel-perfect interfaces that users enjoy intracting with.
                                </p>
